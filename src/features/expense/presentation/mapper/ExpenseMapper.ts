...
export function toExpenseDTO(expense: ExpenseEntity): ExpenseDTO {
  return {
    ...
    validatedByAdmin: expense.validatedByAdmin!,
    validatedBySuperAdmin: expense.validatedBySuperAdmin!,
...
export function toExpenseEntity(record: any): ExpenseEntity {
  return {
    ...
    validatedByAdmin: record.validatedByAdmin,
    validatedBySuperAdmin: record.validatedBySuperAdmin,
